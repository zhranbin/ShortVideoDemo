//
//  RBBaseViewController.swift
//  Housekeeping
//
//  Created by RanBin on 2021/10/13.
//

import UIKit

class RBBaseViewController: UIViewController {
...
//        self.view.backgroundColor = .white
    ...
    deinit {
        print("\(self)：\(String(describing: self.title)) - 被销毁了。")
    }
...
//        backButton.addClickEdgeInsets = UIEdgeInsets(top: 10, left: 10, bottom: 15, right: 15)
    ...
    func setNavTitle(title:String) {
        self.setNavTitle(title: title, color: hexColor(0x121212));
    }
