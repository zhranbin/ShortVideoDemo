...
//        self.masksToBounds = false
    ...
    func cornerAndShadow(color: UIColor, offset:CGSize, opacity:Float, shadowRadius:CGFloat, radius:CGFloat) {
        self.layer.shadowColor = color.cgColor
        self.layer.shadowOffset = offset
        self.layer.shadowOpacity = opacity
    ...
    @IBInspectable var borderColor: UIColor {
        get{
            UIColor(cgColor: self.layer.borderColor ?? CGColor(red: 0, green: 0, blue: 0, alpha: 0))
        }
        set {
